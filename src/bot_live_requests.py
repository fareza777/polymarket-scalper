"""
Polymarket Scalper Bot - LIVE with requests
"""
import asyncio
import logging
import signal
...
from polymarket_requests_api import PolymarketRequestsAPI


class LiveTrader:
    def __init__(self, api: PolymarketRequestsAPI):
        self.api = api
        self.positions = {}
        self.trades = []
        self.daily_pnl = 0.0
...
class LiveBot:
    def __init__(self):
        self.api = PolymarketRequestsAPI()
    ...
    async def start(self):
        logger.info("=" * 70)
        logger.info("POLYMARKET SCALPER BOT - LIVE MODE (Requests)")
        logger.info("=" * 70)
